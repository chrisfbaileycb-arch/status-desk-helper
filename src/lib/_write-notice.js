/**
 * Whacka client SDK — _write-notice (stub)
 *
...
export const showWriteLimitNotice = __wk('showWriteLimitNotice');
export const hideWriteLimitNotice = __wk('hideWriteLimitNotice');
export const writeNoticeState = __wk('writeNoticeState');
