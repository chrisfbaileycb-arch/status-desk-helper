/**
 * Whacka client SDK — _read-notice (stub)
 *
...
export const showReadLimitNotice = __wk('showReadLimitNotice');
export const hideReadLimitNotice = __wk('hideReadLimitNotice');
export const readNoticeState = __wk('readNoticeState');
