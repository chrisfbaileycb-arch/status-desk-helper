/**
 * Whacka client SDK — _embed-shims (stub)
 *
...
export const BLOCKED_DIALOG_MS = __wk('BLOCKED_DIALOG_MS');
export const dialogLooksBlocked = __wk('dialogLooksBlocked');
export const externalLinkTarget = __wk('externalLinkTarget');
export const embedShimState = __wk('embedShimState');
export const installEmbedShims = __wk('installEmbedShims');
