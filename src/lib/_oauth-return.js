/**
 * Whacka client SDK — _oauth-return (stub)
 *
...
export const MAX_RETURN_PATH = __wk('MAX_RETURN_PATH');
export const safeReturnPath = __wk('safeReturnPath');
export const currentReturnPath = __wk('currentReturnPath');
export const parseOAuthReturnHash = __wk('parseOAuthReturnHash');
